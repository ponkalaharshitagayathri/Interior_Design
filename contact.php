...
$sql="INSERT INTO contact (first_name,last_name,email,number,address,city,zipcode,budget,about)
VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[number]','$_POST[address]','$_POST[city]','$_POST[zip]','$_POST[budget]','$_POST[how]');";
